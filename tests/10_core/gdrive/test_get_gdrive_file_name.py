...
test_cases_valid = [
    # file: GoogleDriveFile, expected_result: str
...
@pytest.mark.parametrize(["file", "expected_result"], test_cases_valid)
def test_valid(file: GoogleDriveFile, expected_result: str):
    result = get_gdrive_file_name(file)
