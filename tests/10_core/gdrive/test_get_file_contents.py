...
def test_do_not_log_exception(
    ...
    with caplog.at_level(logging.WARNING):
        with pytest.raises(exception_type):
            _ = mock_gdrive_client.get_file_contents(random_gdrive_file)
...
def test_log_exception(
    ...
    assert random_gdrive_file.name in caplog.text
...
def test_returns_contents(
    ...
    result = mock_gdrive_client.get_file_contents(random_gdrive_file)
    assert result == random_gdrive_file.content
