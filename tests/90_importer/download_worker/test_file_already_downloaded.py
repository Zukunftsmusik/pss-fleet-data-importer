...
def test_return_true_if_exists_with_correct_size(filesystem: FileSystem, fake_queue_item: CollectionFileQueueItem, fake_gdrive_file: FakeGDriveFile):
...
def test_return_false_if_not_exists(filesystem: FileSystem, fake_queue_item: CollectionFileQueueItem):
    assert file_already_downloaded(fake_queue_item, filesystem=filesystem) is False


def test_return_false_if_size_not_match(filesystem: FileSystem, fake_queue_item: CollectionFileQueueItem):
